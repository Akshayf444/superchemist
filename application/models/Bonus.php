...
class Bonus extends MY_model {
    ...
    public function getBonus($condition = array(), $limit, $offset, $order_by = "", $brand_condition = array(), $favourite = array()) {
        ...
        $sql .=!empty($favourite) ? " AND " . join(" AND ", $favourite) : " ";
        $sql .= " ) as fv ON fv.bonus_id = bf.bonus_id INNER JOIN company_master cm ON cm.company_id = bd.company  {$order_by} LIMIT {$limit} OFFSET {$offset}";
        //echo $sql;
    ...
    public function getBonus2($condition = array(), $limit, $offset, $order_by = "", $brand_condition = array(), $favourite = array()) {
        ...
        $sql .=!empty($favourite) ? " AND " . join(" AND ", $favourite) : " ";
        $sql .= " ) as fv ON fv.bonus_id = bf.bonus_id ";
        $sql .= " {$order_by}";
    ...
    public function countBonus2($condition = array(), $brand_condition = array()) {
